...
def get_eating(user):
    ...
    kb.add(types.InlineKeyboardButton(text = mix+'Добавить ингредиенты', callback_data = 'cafe?unset_take_away'), types.InlineKeyboardButton(text = take_away+'Убрать ингредиенты', callback_data = 'cafe?set_take_away'))
